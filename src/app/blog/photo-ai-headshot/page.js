...
<section className=" text-gray-100 py-16">
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        PhotoAI excels in producing detailed images, ranging from wide shots to 
        extreme close-ups, with a focus on photorealism and character consistency.
         Users can generate images that closely resemble real-life scenarios, 
         overcoming common issues found in other AI image generators, such as distorted faces or inconsistent character appearances.
        </p>
