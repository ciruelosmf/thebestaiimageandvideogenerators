...
<div className="grid grid-cols-2 gap-4 mb-12">
        ...
        <span class="font-bold text-2xl text-red-300   ">    Go to GenFoo website</span>
     

          </Link>


    <h2 class="text-2xl font-semibold mt-6 mb-4">AI doesn't have to look boring.</h2>
    ...
    <p class="mb-4">
      GenFoo lets you chat with AI in environments ranging from retro computing terminals to animated dreamscapes. Same intelligence, better experience.
    </p>
  </div>
