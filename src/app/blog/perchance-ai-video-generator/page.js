...
<section className=" text-gray-100 py-16">
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        Perchance AI and AI video generator: The AI generator combo
        </h1>
        ...
        While Perchance AI excels at generating static images, the world of AI-generated content has also videos. Although Perchance AI doesn't have built-in video generation capabilities, there are exciting possibilities when combining its output with other tools.</p>
        ...
        <p className="mb-12 text-xl">
          ...
          <ol className="list-decimal list-inside mb-4 text-xl text-white">
            ...
            <li className="mb-12">Upload the images to an AI video generator like Dream Machine.</li>

       

            <Link  href="https://lumalabs.ai/dream-machine" className="mb-4 text-xl" prefetch={false}>
            
            <p className="mb-4 text-5xl text-red-500 font-mono">
            Go to Dream Machine from lumalabs.ai 
            </p>
